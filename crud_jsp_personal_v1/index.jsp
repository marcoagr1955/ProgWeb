        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="Formulario_alta.jsp">Altas</a></li>
                    <li class="nav-item"><a class="nav-link" href="Editar.jsp">Editar</a></li>
                    <li class="nav-item"><a class="nav-link" href="Baja.jsp">Bajas</a></li>
                    <li class="nav-item"><a class="nav-link" href="index.jsp">Búsquedas</a></li>
                </ul>
            </div>
        </div>
    </nav>
